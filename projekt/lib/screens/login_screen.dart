...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  bool get _isValid => _usernameCtrl.text.trim().isNotEmpty && _passCtrl.text.length >= 6;
      ...
      if (resp.statusCode == 200 && decoded['success'] == true) {
        ...
        try {
          ...
          if (profileResp.statusCode == 200) {
            final data      = jsonDecode(utf8.decode(profileResp.bodyBytes))['data'] as Map<String, dynamic>;
  ...
  void _navigateTo(Widget screen) => Navigator.of(context).pushAndRemoveUntil(
    PageRouteBuilder(
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          const Text('Dobrodošli nazad!', style: TextStyle(
                              color: _bordo, fontSize: 24, fontWeight: FontWeight.w900, letterSpacing: -0.6)),
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: (_isValid && !_loading) ? [BoxShadow(
                                      color: _bordo.withOpacity(0.35), blurRadius: 18, offset: const Offset(0, 7))] : [],
                                ),
                          ...
                          Center(child: GestureDetector(
                            ...
                            child: RichText(text: TextSpan(
                              ...
                              children: [const TextSpan(text: 'Registriraj se',
                                  style: TextStyle(color: _bordo, fontWeight: FontWeight.w800,
    ...
    child: Row(children: [
      ...
      GestureDetector(
        ...
        child: Padding(padding: const EdgeInsets.symmetric(horizontal: 12),
            child: Icon(_showPassword ? Icons.visibility_off_rounded : Icons.visibility_rounded,
...
class _SmoothTabSwitcherState extends State<_SmoothTabSwitcher>
  ...
  void initState() {
    ...
    _indicatorPos = CurvedAnimation(parent: _indicatorCtrl, curve: Curves.easeOutCubic);
  }
  ...
  void didUpdateWidget(_SmoothTabSwitcher old) {
    ...
    if (old.selected != widget.selected) {
      _indicatorCtrl.animateTo(widget.selected.toDouble(), curve: Curves.easeOutCubic);
    }
  }

  @override void dispose() { _indicatorCtrl.dispose(); super.dispose(); }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _bordoLight, borderRadius: BorderRadius.circular(18),
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Transform.translate(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _bordo, borderRadius: BorderRadius.circular(14),
      ...
      child: SizedBox(width: w, height: double.infinity,
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          AnimatedDefaultTextStyle(
            duration: const Duration(milliseconds: 220),
            style: TextStyle(color: active ? Colors.white : _bordo.withOpacity(0.55),
