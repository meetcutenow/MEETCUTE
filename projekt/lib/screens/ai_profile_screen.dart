...
enum _ScreenState { idle, recording, transcribing, parsing, done, error }
...
class _AiProfileScreenState extends State<AiProfileScreen>
  ...
  Future<void> _processAudio() async {
    ...
    try {
      ...
      request.files.add(http.MultipartFile.fromBytes('audio', bytes, filename: 'recording.wav'));
    ...
    try {
      ...
      if (resp.statusCode == 200 && data['success'] == true) {
        setState(() {
          _parsedData = data['data'] as Map<String, dynamic>;
          _state = _ScreenState.done;
        });
      } else {
        setState(() {
          _state = _ScreenState.error;
          _errorMsg = data['message'] ?? 'Greška pri obradi s AI.';
        });
      }
    } catch (_) {
      setState(() {
        _state = _ScreenState.error;
        _errorMsg = 'Greška pri obradi s AI.\nProva internet vezu.';
      });
    }
  }
        ...
        body: FadeTransition(
          ...
          child: SlideTransition(
            ...
            child: Column(children: [
              _buildHeader(MediaQuery.of(context)),
  ...
  Widget _buildIdle() {
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Text('Opiši se glasom!', style: TextStyle(
            color: _primary, fontSize: 26,
            fontWeight: FontWeight.w900, letterSpacing: -0.5)),
        const SizedBox(height: 10),
        Text(
          'AI će automatski popuniti tvoj profil.\nSlike se dodaju ručno.',
          textAlign: TextAlign.center,
          style: TextStyle(color: _primary.withOpacity(0.55), fontSize: 14.5, height: 1.55),
        ),
        const SizedBox(height: 28),
        _buildExampleCard(),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              const Text('Počni snimati', style: TextStyle(
    ...
    return AnimatedContainer(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Text('Što možeš reći:', style: TextStyle(
        ...
        ..._exampleLines.map((line) => Padding(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: _primary.withOpacity(0.40), shape: BoxShape.circle),
            ),
            Expanded(child: Text(line, style: TextStyle(
                color: _primary.withOpacity(0.65), fontSize: 13, height: 1.5))),
          ]),
        )),
      ]),
    );
          ...
          builder: (_, __) => Stack(alignment: Alignment.center, children: [
            ...
            Transform.scale(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle, color: _primary.withOpacity(0.10)),
              ),
            ),
            GestureDetector(
  ...
  Widget _buildProcessing() {
    final (icon, label, sub) = switch (_state) {
      _ScreenState.transcribing => (Icons.graphic_eq_rounded, 'Prepisujem govor...', 'Hvala na strpljenju!'),
      _ScreenState.parsing      => (Icons.auto_awesome_rounded, 'AI popunjava profil...', 'AI izvlači podatke iz teksta'),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('"$_transcript"', style: TextStyle(
                  color: _primary, fontSize: 14, height: 1.5, fontStyle: FontStyle.italic)),
            ]),
          ),
        ],
      ]),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Profil popunjen!', style: TextStyle(
        ...
        if (_transcript != null) AnimatedContainer(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Što si rekao/la:', style: TextStyle(
                color: _primary.withOpacity(0.55), fontSize: 11, fontWeight: FontWeight.w600)),
            const SizedBox(height: 5),
            Text('"$_transcript"', style: TextStyle(
                color: _primary, fontSize: 13, height: 1.5, fontStyle: FontStyle.italic)),
          ]),
        ),
          ...
          Expanded(flex: 2, child: GestureDetector(
            ...
            child: Container(
              ...
              child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                SizedBox(width: 8),
                Text('Primijeni na profil', style: TextStyle(
  ...
  Widget _buildResultRow(_ResultRow row) {
    return Padding(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 10),
        if (row.label.isNotEmpty) Text('${row.label}: ',
            style: TextStyle(color: _primary.withOpacity(0.55), fontSize: 13.5)),
        Expanded(child: Text(row.value, style: TextStyle(
            color: _primary, fontSize: 13.5, fontWeight: FontWeight.w700))),
      ]),
    );
  }
  ...
  static const _hairMap    = {'plava': 'Plava', 'smeda': 'Smeđa', 'crna': 'Crna', 'crvena': 'Crvena', 'sijeda': 'Sijeda', 'ostalo': 'Ostalo'};
