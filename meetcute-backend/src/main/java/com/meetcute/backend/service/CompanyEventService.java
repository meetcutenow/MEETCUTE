...
public class CompanyEventService {
    ...
    public List<EventResponse> getCompanyEvents(String companyId, String userId) {
        ...
        return eventRepository.findByCompanyIdAndIsActiveTrueOrderByEventDateAsc(companyId)
                .stream()
                .map(event -> toResponse(event, companyId,
                        event.getTicketPrice(),
                        event.getTicketCurrency() != null ? event.getTicketCurrency() : "EUR",
    ...
    public List<CompanyEventStatsResponse> getEventStats(String companyId) {
        return jdbcTemplate.query(
                "SELECT event_id, title, event_date, total_joined, total_cancelled, " +
    ...
    private EventResponse toResponse(Event e, String companyId, Double ticketPrice,
                                     String currency, String orgName, String logoUrl,
